...
/**
 * Inicializa y configura todas las capas de la aplicación.
 */
export async function bootstrap() {
  ...
  appStore.subscribe(async (state) => {
    ...
    // 1. Guardar el estado del dibujo de la provincia anterior inmediatamente
    ...
    // 3. Cargar el mapa en el Canvas con pantalla de carga
  ...
  customColorPicker.addEventListener('change', (e) => {
    ...
    const targetChip = colorChipsContainer.querySelector(
  ...
  try {
    ...
    // Refrescar iconos cargados dinámicamente
    if (window.lucide) {
      window.lucide.createIcons()
    }
